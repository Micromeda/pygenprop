...
NUMBER_OF_PROPS=$(grep 'AC  GenProp' ./pygenprop/testing/test_constants/test_genome_properties.txt | wc -l | tr -d ' ')
NUMBER_OF_PROPS_PARSED=$(./pygenprop/testing/test_parse_genome_properties_file.py  -i ./pygenprop/testing/test_constants/test_genome_properties.txt | grep -o '^[1-9]*')
